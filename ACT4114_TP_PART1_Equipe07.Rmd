...
md.pattern(Veh, rotate.names = T) # retirer avant remise
...
La variable «Gender» est rarement absente toute seule. Dans la majorité des observations où cette variable est absente, «DrivAge» l'est également. Testons l'hypothèse nulle que le patron de non-réponse de la variable «Gender» est MCAR.
```{r, message=FALSE, echo=FALSE}
