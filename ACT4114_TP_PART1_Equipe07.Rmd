...
[SUSEP - Superintendência de Seguros Privados, 2013] SUSEP - Superintendência de Seguros Privados, \hspace*{24pt}(2013). Autoseg - Sistema de estatísticas de automóveis da susep. https://www2.susep.gov.br/menues \hspace*{24pt}tatistica/Autoseg/principal.aspx.
...
```{r removecorporate, echo=FALSE, message=FALSE}
Veh <- Veh[!Veh$Gender == 'Corporate' | is.na(Veh$Gender),]
```
...
```{r, echo=F}
Veh <- Veh[, !names(Veh) %in% c("VehModel", "VehGroup")]
