...
\begin{center}
Table 1 : Statistiques sommaires du logarithme des réclamations
...
plot_pattern(Veh[, colSums(is.na(Veh)) != 0], rotate = F) +
  labs(x = "Nombre de valeurs manquantes par variable", y = "Fréquence du motif de non-réponse") +
...
Nous avons constaté que lorsque le modèle de véhicule est manquant pour une observation, les valeurs correspondantes pour les variables VehGroup et VehManuf sont également manquantes. Pour déterminer si les variables *VehModel* et *VehGroup* fournissent des informations utiles pour notre analyse, nous en faisons une courte analyse: 
```{r, echo=F}
