...
Il y a seulement une observation avec un donnée manquante pour la variable «VehYear». En raison de la faible importance de cette observation vis à vis la grande taille du jeu de donnée, nous la retirons du jeu de données.
```{r, message=FALSE, echo=FALSE}
