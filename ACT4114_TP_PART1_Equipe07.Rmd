...
Nous pouvons voir que lorsque le modèle du véhicule est manquant pour une observation, le groupe et le manufacturier de cette même observation sont aussi manquants. Nous examinons les variables *VehModel* et *VehGroup* pour déterminer si elles fournissent une information utile pour notre analyse. 
```{r}
...
En examinant en détails ces variables, nous constatons que le nombre de niveaux de chacune est très élevé, ce qui n'est pas optimal pour l'imputation des données. 
```{r}
